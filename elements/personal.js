// // Populate day dropdown on focus
...
//     // Enable the submit button if all dropdowns have selected valid options
...
// // Add event listeners to dropdowns to validate the selections
// document.getElementById('day').addEventListener('change', checkValidSelections);
// document.getElementById('month').addEventListener('change', checkValidSelections);
// document.getElementById('year').addEventListener('change', checkValidSelections);
